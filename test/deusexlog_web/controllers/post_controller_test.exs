defmodule DeusexlogWeb.PostControllerTest do
  use DeusexlogWeb.ConnCase

  alias Deusexlog.Posts

  @create_attrs %{body: "some body", cover: "some cover", published: true, slug: "some slug", title: "some title", views: 42}
