defmodule DeusexlogWeb.UserControllerTest do
  use DeusexlogWeb.ConnCase

  alias Deusexlog.Users

  @create_attrs %{access: "some access", bio: "some bio", email: "some email", image: "some image", username: "some username"}
  ...
  describe "update user" do
    ...
    test "redirects when data is valid", %{conn: conn, user: user} do
      ...
      assert html_response(conn, 200) =~ "some updated access"
    end
