defmodule SlumberingmageWeb.PostControllerTest do
  use SlumberingmageWeb.ConnCase

  alias Slumberingmage.CreatePost

  @create_attrs %{content: "some content", date_published: ~D[2010-04-17], excerpt: "some excerpt", published: true, title: "some title", url: "some url"}
  ...
  def fixture(:post) do
    {:ok, post} = CreatePost.create_post(@create_attrs)
    post
  end
