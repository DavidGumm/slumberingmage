defmodule SlumberingmageWeb.CommentControllerTest do
  use SlumberingmageWeb.ConnCase

  alias Slumberingmage.Comments

  @create_attrs %{author: "some author", avatar: "some avatar", comments: "some comments", date: ~N[2010-04-17 14:00:00]}
