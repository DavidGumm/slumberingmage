...
# })
  ...
  Slumberingmage.Posts.create_post(%{
    slug: "from-c#-to-Elixir",
    title: "From c# to Elixir",
    body: "Learning Elixir as a c# Developer has been an eye opener.
